...
public class SystemPropertiesSheetBuilderTest {
    private static final String TEMPLATE_PATH = "com/yqboots/initializer/core/workbook.xlsx";

    @Autowired
    private SystemPropertiesSheetBuilder systemPropertiesSheetBuilder;
    ...
    public void testBuild() throws Exception {
        try (InputStream inputStream = new ClassPathResource(TEMPLATE_PATH).getInputStream()) {
            ...
            XSSFSheet sheet = workbook.getSheet("System Properties");

            systemPropertiesSheetBuilder.build(properties.getTargetPath(), null, sheet);
        }
    }
}